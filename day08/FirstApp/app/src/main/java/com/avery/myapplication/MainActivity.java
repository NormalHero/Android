...
public class MainActivity extends AppCompatActivity {
    ...
    TextView etID,etPW ;
    Button btnLogin,btnList, btnMemberList, btnRecycleMemberList;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnRecycleMemberList = findViewById(R.id.btnRecycleMemberList);
        btnRecycleMemberList.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
